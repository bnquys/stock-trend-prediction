...
Generated by Repomix on: 2026-09-17 20:42:28
...
```python
"""src/api — TenacoreX Market API (CSV-only, no AI)."""
...
## src/fundamental/config.yaml

```yaml
# ════════════════════════════════════════════════════════════════
# Fundamental Config — LLM & Embedding Pipeline
# Đặt trong package src/fundamental/ để dễ quản lý
# enabled flag nằm trong configs/config.yaml → analysis.enabled
# ════════════════════════════════════════════════════════════════
...
```python
"""Trading Simulation UI — Gradio-based real-time trading simulator."""
```

## src/ui/__main__.py

```python
"""Allow running as: python -m src.ui"""
